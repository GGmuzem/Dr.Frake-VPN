...
const ITEMS: FaqItem[] = [
  ...
  },
  {
    ...
    answer:
      "Всех российских банковских карт. Оплата идёт через YooKassa, подписка активируется сразу после платежа. Автопродления нет — продлеваете вручную в личном кабинете.",
  },
  {
